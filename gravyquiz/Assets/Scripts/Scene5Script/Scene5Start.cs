...
public class Scene6Start : MonoBehaviour
{
    ...
    void phasecontinue()
    {
        ...
        {   // we use a switch case statement for our count as we increment past the phases
            ...
            {
                case 0:
                    StartCoroutine(type(BigBubbleTxt.GetComponent<TextMeshProUGUI>(), "LET'S USE IT TO GO TO THE MALL!"));

                    break;
                case 1:

                    SceneManager.LoadScene("GravyQuizScene6");
                    break;
