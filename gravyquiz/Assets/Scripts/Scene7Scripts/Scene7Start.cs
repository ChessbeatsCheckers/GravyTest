...
public class Scene7Start : MonoBehaviour
{
    ...
    void phasecontinue()
    {
        ...
        if (!debounce)
        {
            ...
            {
                case 0:
                    StartCoroutine(type(BigBubbleTxt.GetComponent<TextMeshProUGUI>(), "How about we enjoy our time here at the beach."));

                    break;
                case 1:

                    Debug.Log("Game is over, ggs");
                    break;
