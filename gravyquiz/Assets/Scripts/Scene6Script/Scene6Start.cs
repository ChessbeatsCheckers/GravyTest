...
public class Scene5Start : MonoBehaviour
{
    ...
    void phasecontinue()
    {
        ...
        if (!debounce)
        {
            ...
            {
                case 0:
                    StartCoroutine(type(BigBubbleTxt.GetComponent<TextMeshProUGUI>(), "Nah, I say let's use it to head to the surf shop.."));

                    break;
                case 1:

                    SceneManager.LoadScene("GravyQuizScene7");
                    break;
