...
public class Scene3Start : MonoBehaviour
{
    ...
    void phasecontinue()
    {
        ...
        if (!debounce)
        {
            ...
            {
                case 0:
                    StartCoroutine(type(BigBubbleTxt.GetComponent<TextMeshProUGUI>(), "You're no fun.. Btw, where's Bear? Wasn't she coming with you?"));

                    break;
                case 1:

                    SceneManager.LoadScene("GravyQuizScene3.5");
                    break;
