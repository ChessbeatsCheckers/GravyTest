...
{   // This is our button covering the whole screen
    ...
    void phasecontinue()
    {
        ...
        { debounce = true;
            ...
            { 
                case 0:
                    StartCoroutine(type(SmallBubbleTxt.GetComponent<TextMeshProUGUI>(), "NO WAY! "));
                    
                    break;
                case 1:
                    
                    StartCoroutine(type(BigBubbleTxt.GetComponent<TextMeshProUGUI>(), "THIS NEW APP ALLOWS YOU TO TELEPORT ANYWHERE YOU WANT!"));
                    break;
                case 2:
                    SceneManager.LoadScene("GravyQuizScene5");
                    break; 
